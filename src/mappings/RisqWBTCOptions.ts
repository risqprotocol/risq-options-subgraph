import { Create, Exercise, Expire, SetImpliedVolRateCall } from '../types/RisqWBTCOptions/RisqOptions'
...
export function handleCreate(event: Create): void {
  ...
  // Create option
  let option = new RisqOption("WBTC-" + event.params.id.toString());
...
export function handleExercise(event: Exercise): void {
  ...
  let option = RisqOption.load("WBTC-" + event.params.id.toString())
  if (option == null) {
    return
  }
