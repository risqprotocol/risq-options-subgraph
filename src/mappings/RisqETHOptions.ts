import { Create, Exercise, Expire, SetImpliedVolRateCall } from '../types/RisqETHOptions/RisqOptions'
import { Asset, RisqOption, ImpliedVolatility } from '../types/schema'
import { RisqOptions as Contract } from '../types/RisqETHOptions/RisqOptions'
...
export function handleCreate(event: Create): void {
  ...
  // Create option
  let option = new RisqOption("ETH-" + event.params.id.toString());
...
export function handleExercise(event: Exercise): void {
  ...
  let option = RisqOption.load("ETH-" + event.params.id.toString())
  if (option == null) {
    return
  }
